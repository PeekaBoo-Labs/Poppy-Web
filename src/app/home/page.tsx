...
function QuestionBlock({ className = '' }) {
  return (
    <div className={`flex justify-center items-center p-2 rounded-3xl border-[2px] border-gray-200 bg-[#FFF] overflow-hidden h-[230px] mb-[-200px] ${className}`}>
  ...
  return (
    <body className="bg-[#F7F7F7]">
      <div className="flex flex-col justify-center items-center bg-[#F7F7F7] text-[#262626]">
          ...
          <div className="flex flex-col justify-between h-[87vh]">
            <div className="flex-grow"></div>
              <div className="flex flex-col justify-center mx-auto">
                <Title className="text-center mb-4 px-10">Tap and unwrap.</Title>
                <Title className="text-center mb-8 px-10">Wellness in your lap.</Title>
                <h3 className="text-center px-10 font-[400]">An AI powered STI screening service.</h3>
              </div>
            <div className="flex-grow"></div>
        </div>
          ...
          <div className="flex flex-col justify-between h-[50vh]">
            <div className="flex-grow"></div>
              <div className="flex flex-col justify-center mx-auto">
                ...
                <h3 className="text-center px-10 font-[400]">Never touch the command line, from provision to production.</h3>
              </div>
            <div className="flex-grow"></div>
        </div>
          ...
          <div className="flex flex-col justify-between h-[50vh]">
            <div className="flex-grow"></div>
              <div className="flex flex-col justify-center mx-auto">
                ...
                <h3 className="text-center px-10 font-[400]">Logical can get systems to market in minutes instead of weeks.</h3>
              </div>
            <div className="flex-grow"></div>
        </div>
        ...
        <div className="w-40 h-40 rounded-2xl border-[2px] border-[#262626] bg-[#F7F7F7] mb-8 flex justify-center items-center">
        ...
        <div className="flex flex-col justify-center bg-[#FFE819] text-[#262626] p-4 pt-16 w-full">
          ...
          <div className="flex flex-grow justify-between items-center px-4 py-2.5 rounded-[15px] border-[2px] border-black select-none cursor-default">
            <h4 className="text-[#262626] font-[400]">Enter your email</h4>
            <Caption className="text-[#262626] font-[500]">SEND</Caption>
          </div>

          <Caption className="flex justify-center align-center text-center text-[#262626] opacity-50 mt-16 mb-4 px-4">By clicking send you'll receive occasional emails from Chute. You always have the choice to unsubscribe within every email you receive.</Caption>
        ...
        <div className="flex flex-col justify-center bg-[#262626] text-[#F7F7F7] p-4 w-full">
            ...
            <div className="mt-4 flex items-center gap-4">
              ...
              <a className="[&amp;>svg]:fill-primary-300 [&amp;>svg]:transition-fill [&amp;>svg]:duration-150 [&amp;>svg]:hover:fill-white" aria-label="Discord" target="_blank" rel="noopener" href="https:///discord">
              ...
              <a className="[&amp;>svg]:fill-primary-300 [&amp;>svg]:transition-fill [&amp;>svg]:duration-150 [&amp;>svg]:hover:fill-white" aria-label="Twitter" target="_blank" rel="noopener" href="https://twitter.com">
