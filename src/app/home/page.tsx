...
<body className="bg-[#F7F7F7]">
    <div className="flex flex-col justify-center items-center bg-[#F7F7F7] text-[#262626]">
        ...
        <Image width={1450} height={2936} className="fixed bottom-[-590px] z-[99] w-[95vw] mt-[1px]" src="/phone.png"
            alt="Phone" />
        ...
        <div className="flex flex-col mx-4 max-w-[750px]">
            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-col mb-[100px]">
                    ...
                    <h5 className="flex justify-center align-center text-center text-[#262626] mb-8 px-8">Trusted by
                    </h5>

                    <div className="flex overflow-x-scroll space-x-6 no-scrollbar px-4">
                        <img alt="Adobe Logo" loading="lazy" className="h-6"
                            src="https://assets.vercel.com/image/upload/front/home/new/logos/adobe.svg" />
                        <img alt="Okta Logo" loading="lazy" className="h-6"
                            src="https://assets.vercel.com/image/upload/front/home/new/logos/okta.svg" />
                        <img alt="Under Armour Logo" loading="lazy" className="h-6"
                            src="https://assets.vercel.com/image/upload/front/home/new/logos/under-armour.svg" />
                        <img alt="eBay Logo" loading="lazy" className="h-6"
                            src="https://assets.vercel.com/image/upload/front/home/new/logos/ebay.svg" />
                        <img alt="Zapier Logo" loading="lazy" className="h-6"
                            src="https://assets.vercel.com/image/upload/front/home/new/logos/zapier.svg" />
                        <img alt="Loom Logo" loading="lazy" className="h-6"
                            src="https://assets.vercel.com/image/upload/front/home/new/logos/loom.svg" />
                        <img alt="HashiCorp Logo" loading="lazy" className="h-6"
                            src="https://assets.vercel.com/image/upload/front/home/new/logos/hashicorp.svg" />
                        <img alt="Tailwindcss Logo" loading="lazy" className="h-6"
                            src="https://assets.vercel.com/image/upload/front/home/new/logos/tailwindcss.svg" />
                        <img alt="Washington Post Logo" loading="lazy" className="h-6"
                ...
                <div className="flex flex-col">
                    <div className="flex flex-col justify-between h-[50vh]">
                        ...
                        <div className="flex flex-col justify-center mx-auto">
                            <Title className="text-center mb-8 px-10">Completely Visual</Title>
                            <h3 className="text-center px-10 font-[400]">Never touch the command line, from provision to
                                production.</h3>
                        </div>
                        <div className="flex-grow"></div>
                    </div>
                    ...
                    <div className="flex flex-col">
                        <div className="flex flex-col justify-between h-[50vh]">
                            ...
                            <div className="flex flex-col justify-center mx-auto">
                                ...
                                <h3 className="text-center px-10 font-[400]">Logical can get systems to market in
                                    minutes instead of weeks.</h3>
                            </div>
                            <div className="flex-grow"></div>
                        </div>
        ...
        <div className="flex flex-col justify-center bg-[#262626] text-[#F7F7F7] p-4 w-full">
            ...
            <div className="mt-4 flex items-center gap-4">
                ...
                <a className="[&amp;>svg]:fill-primary-300 [&amp;>svg]:transition-fill [&amp;>svg]:duration-150 [&amp;>svg]:hover:fill-white"
                    aria-label="Discord" target="_blank" rel="noopener" href="https:///discord">
                    <svg className="mt-0.5" width="22" height="22" fill="currentColor"
                ...
                <a className="[&amp;>svg]:fill-primary-300 [&amp;>svg]:transition-fill [&amp;>svg]:duration-150 [&amp;>svg]:hover:fill-white"
                    aria-label="Twitter" target="_blank" rel="noopener" href="https://twitter.com">
                    <svg className="mt-1" width="22" height="22" viewBox="0 0 26 26"
                        aria-label="X formerly known as Twitter" fill="currentColor">
                        <path
