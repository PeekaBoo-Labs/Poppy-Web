...
export default function FlipCard({ state, children }: { state: CardState, children?: React.ReactNode }) {
  ...
  return <>
    <motion.div
      className="w-[350px] h-[550px] bg-[rgba(0,0,0,0.08)] rounded-[30px] flex items-center justify-center text-3xl font-bold border-zinc-700 absolute blur-[8px]"
    ...
    <motion.div
      ...
      className="w-[350px] h-[550px] bg-stone-100 rounded-[30px] flex flex-col items-center justify-around text-3xl font-bold border-zinc-700 absolute"
    >
      Flip the Card

      {children}

      <img src="https://source.unsplash.com/random" className="w-[250px] h-[250px] object-fit" />
    </motion.div>
  </>
}
