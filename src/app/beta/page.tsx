...
const data = [
  { id: 1, title: "Are you question one?" },
  { id: 2, title: "Are you question two?" },
  { id: 3, title: "Have you ever asked question three?" },
];
      ...
      setTimeout(() => {
        setCardData((prev) => {
          ...
          newData.push({
            ...
            title:
              "This is an autogenerated question #" +
          ...
          <AnimatePresence initial={false}>
            {[...cardData].reverse().map((card, i) => (
              <FlipCard
                width={width}
                key={`card-${card.id}`}
                state={i == 2 ? mousePosition : i == 1 ? "second" : "third"}
              >
