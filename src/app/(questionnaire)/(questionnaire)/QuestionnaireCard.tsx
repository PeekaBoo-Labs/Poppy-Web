    ...
    <>
      {!currentQuestion ? null : (
        <div className="flex flex-grow flex-col md:flex-row md:gap-[40px]">
          <div className="z-10 rounded-[20px] border border-border bg-secondary-background p-[7px] shadow-realistic md:w-[60%]">
            <div className="grid h-full w-full place-content-center rounded-[13px] border border-border p-[10vw] md:p-[135px]">
          ...
          <div className="flex flex-shrink-0 flex-grow basis-0 flex-col justify-between gap-4">
            ...
            <button
              className="group flex items-center justify-between rounded-[13px] border-2 border-primary bg-primary px-[16px] py-[13px] text-white md:hover:bg-transparent md:hover:text-primary"
              onClick={handleNext}
            >
              Next
              <svg
