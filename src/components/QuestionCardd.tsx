...
import { QuestionOption } from '@/lib/types/question';
import { type Question } from '@/lib/types/question'

const QuestionCardd = ({ question, options, question_index, questions, setQuestions }:
  { question: string, options: QuestionOption[], question_index: number, questions: QuestionType[], setQuestions: Function }) => {
        ...
        <div className="flex flex-col justify-center mx-auto">
          ...
          <div className="flex flex-wrap justify-center items-center">
            {options.map((option, index) => (
              ...
              >
                <QuestionInputOption text={option.content} selected={option.user_input} />
